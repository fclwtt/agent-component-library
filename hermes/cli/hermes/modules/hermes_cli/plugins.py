...
class PluginContext:
    ...
    def llm(self) -> Any:
        ...
        if self._llm is None:
            from components.agent-engine.api import PluginLlm
    ...
    def register_tool(
        ...
        """
        from components.tool-system.api import registry
    ...
    def register_context_engine(self, engine) -> None:
        ...
        from components.agent-engine.api import ContextEngine
    ...
    def register_image_gen_provider(self, provider) -> None:
        ...
        tool calls.
        """
        from components.agent-engine.api import ImageGenProvider
        from components.agent-engine.api import register_provider
    ...
    def register_video_gen_provider(self, provider) -> None:
        ...
        tool calls.
        """
        from components.agent-engine.api import VideoGenProvider
    ...
    def register_web_search_provider(self, provider) -> None:
        ...
        tool calls.
        """
        from components.agent-engine.api import WebSearchProvider
    ...
    def register_browser_provider(self, provider) -> None:
        ...
        """
        from components.agent-engine.api import BrowserProvider
    ...
    def register_tts_provider(self, provider) -> None:
        ...
        """
        from components.agent-engine.api import TTSProvider
    ...
    def register_transcription_provider(self, provider) -> None:
        ...
        **but only when**:
        ...
        backends).
        """
        from components.agent-engine.api import TranscriptionProvider
    ...
    def register_platform(
        ...
        **entry_kwargs: Any,
        ...
        """
        from components.gateway.api import platform_registry, PlatformEntry
    ...
    def register_skill(
        ...
        """
        from components.agent-engine.api import _NAMESPACE_RE
