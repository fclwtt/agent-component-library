...
def _provider_base_url(provider: str) -> str:
    ...
    if provider.startswith(CUSTOM_POOL_PREFIX):
        from components.agent-engine.api import _get_custom_provider_config
...
def auth_remove_command(args) -> None:
    ...
    from components.agent-engine.api import find_removal_step
...
def _interactive_auth() -> None:
    ...
    try:
        from components.agent-engine.api import has_aws_credentials, resolve_aws_auth_env_var, resolve_bedrock_region
