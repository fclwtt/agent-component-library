...
def cmd_sync(args) -> None:
    ...
    """
    try:
        from components.cli.api import list_profiles
...
def _gateway_platforms() -> list[str] | None:
    ...
    """
    try:
        from components.gateway.api import load_gateway_config
...
def _prompt(label: str, default: str | None = None, secret: bool = False) -> str:
    ...
    if secret:
        if sys.stdin.isatty():
            from components.cli.api import masked_secret_prompt
...
def cmd_setup(args) -> None:
    ...
    try:
        from components.cli.api import load_config, save_config
...
def honcho_command(args) -> None:
    ...
    if sub == "setup":
        ...
        from components.cli.api import cmd_setup_provider
