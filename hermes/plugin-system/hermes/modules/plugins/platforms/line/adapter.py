...
class LineAdapter(BasePlatformAdapter):
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            from components.gateway.api import acquire_scoped_lock
    ...
    async def disconnect(self) -> None:
        ...
        if self._lock_key:
            try:
                from components.gateway.api import release_scoped_lock
...
def interactive_setup() -> None:
    ...
    try:
        from components.cli.api import get_env_var, set_env_var
    except ImportError:
