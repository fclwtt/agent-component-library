...
from components.tool-system.api import discover_builtin_tools, registry
...
def get_tool_definitions(
    ...
    if quiet_mode:
        try:
            from components.cli.api import get_config_path
...
def _compute_tool_definitions(
    ...
    if "execute_code" in available_tool_names:
        from components.tool-system.api import SANDBOX_ALLOWED_TOOLS, build_execute_code_schema, _get_execution_mode
    ...
    try:
        from components.tool-system.api import sanitize_tool_schemas
    ...
    try:
        from components.tool-system.api import assemble_tool_defs, load_config as _load_ts_config
...
def _resolve_active_context_length() -> int:
    ...
    try:
        ...
        if not model_id:
            return 0
        from components.agent-engine.api import get_model_context_length
...
def _emit_post_tool_call_hook(
    *,
    ...
    """
    try:
        from components.cli.api import has_hook, invoke_hook
...
def handle_function_call(
    ...
    if not skip_tool_request_middleware:
        try:
            from components.cli.api import apply_tool_request_middleware
    ...
    try:
        ...
        if not skip_pre_tool_call_hook:
            ...
            try:
                from components.cli.api import get_pre_tool_call_block_message
        ...
        try:
            from components.acp-adapter.api import maybe_require_edit_approval
        ...
        if function_name not in _READ_SEARCH_TOOLS:
            try:
                from components.tool-system.api import notify_other_tool_call
        ...
        try:
            ...
            from components.cli.api import run_tool_execution_middleware
