...
from components.agent-engine.api import ModelInfo
...
def expensive_model_warning(
    ...
    *,
    ...
    if input_cost is None and output_cost is None and provider:
        try:
            from components.agent-engine.api import get_model_info
    ...
    if input_cost is None and output_cost is None:
        try:
            from components.agent-engine.api import get_pricing_entry
