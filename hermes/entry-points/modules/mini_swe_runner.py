...
from components.agent-engine.api import make_tool_result_message
...
def create_environment(
    ...
    **kwargs
    ...
    """
    if env_type == "local":
        from components.tool-system.api import LocalEnvironment
        return LocalEnvironment(cwd=cwd, timeout=timeout)
    
    elif env_type == "docker":
        from components.tool-system.api import DockerEnvironment
        return DockerEnvironment(image=image, cwd=cwd, timeout=timeout, **kwargs)
    
    elif env_type == "modal":
        from components.tool-system.api import ModalEnvironment
