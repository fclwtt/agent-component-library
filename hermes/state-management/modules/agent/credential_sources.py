...
def _remove_env_source(provider: str, removed) -> RemovalResult:
    ...
    """
    from components.cli.api import get_env_path, remove_env_value
...
def _remove_hermes_pkce(provider: str, removed) -> RemovalResult:
    ...
    import os; def _get_hermes_home(): return os.environ.get("HERMES_HOME", os.path.expanduser("~/.hermes"))
...
def _remove_codex_device_code(provider: str, removed) -> RemovalResult:
    ...
    """
    from components.cli.api import suppress_credential_source
