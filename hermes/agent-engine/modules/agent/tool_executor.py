...
from components.tool-system.api import propagate_context_to_thread
from tools.tool_result_storage import (
    maybe_persist_tool_result,
    enforce_turn_budget,
)
from components.tool-system.api import BudgetConfig, DEFAULT_BUDGET, budget_for_context_window
...
def _emit_terminal_post_tool_call(
    ...
    *,
    ...
    try:
        from components.entry-points.api import _emit_post_tool_call_hook
...
def execute_tool_calls_concurrent(agent, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0) -> None:
    ...
    def _run_tool(index, tool_call, function_name, function_args, middleware_trace):
        ...
        try:
            from components.tool-system.api import set_activity_callback
    ...
    for i, tool_call in enumerate(assistant_message.tool_calls, 1):
        ...
        if _block_msg is not None:
            ...
            def _execute(next_args: dict) -> Any:
                ...
                if not session_db:
                    from components.entry-points.api import format_session_db_unavailable
