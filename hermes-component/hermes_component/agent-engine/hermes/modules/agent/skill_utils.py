...
from components.entry-points.api import get_config_path, get_skills_dir, is_termux
...
def _detect_environment(env: str) -> bool:
    ...
    if env == "kanban":
        ...
        if os.getenv("HERMES_KANBAN_TASK") or os.getenv("HERMES_KANBAN_BOARD"):
            ...
            try:
                from components.tool-system.api import _profile_has_kanban_toolset
        ...
        try:
            from components.entry-points.api import is_container
