...
def match_blueprint(query: str) -> Tuple[Optional[Any], List[Any]]:
    ...
    """
    from components.cron.api import CATALOG, get_blueprint
...
def build_blueprint_seed(blueprint) -> str:
    ...
    """
    from components.cron.api import WEEKDAY_PRESETS
...
def _fmt_catalog() -> str:
    from components.cron.api import CATALOG
...
def handle_blueprint_command(
    ...
    *,
    ...
    """
    try:
        from components.cron.api import fill_blueprint, BlueprintFillError
    ...
    try:
        from components.cron.api import create_job
