...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    """
    from components.entry-points.api import check_tool_availability, TOOLSET_REQUIREMENTS
    from rich.panel import Panel
    from rich.table import Table
    if get_toolset_for_tool is None:
        from components.entry-points.api import get_toolset_for_tool
    ...
    try:
        from components.tool-system.api import get_mcp_status
