...
def compress_context(
    ...
    *,
    ...
    if agent._session_db:
        try:
            ...
            if in_place:
                ...
                try:
                    from components.entry-points.api import set_session_context
                ...
                try:
                    from components.cli.api import migrate_goal_to_session
    ...
    try:
        from components.tool-system.api import reset_file_dedup
...
def try_shrink_image_parts_in_messages(
    ...
    *,
    ...
    try:
        from components.tool-system.api import _resize_image_for_vision
    except Exception as exc:
