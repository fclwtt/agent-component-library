...
def _translate_acp_cwd(cwd: str) -> str:
    ...
    """
    from components.entry-points.api import is_wsl
...
def _register_task_cwd(task_id: str, cwd: str) -> None:
    ...
    if not task_id:
        return
    try:
        from components.tool-system.api import register_task_env_overrides
...
def _clear_task_cwd(task_id: str) -> None:
    ...
    if not task_id:
        return
    try:
        from components.tool-system.api import clear_task_env_overrides
...
class SessionManager:
    ...
    def _make_agent(
        ...
        *,
        ...
        from components.entry-points.api import AIAgent
        from components.cli.api import load_config
        from components.cli.api import resolve_runtime_provider
