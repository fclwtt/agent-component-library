...
from components.entry-points.api import env_var_enabled, is_truthy_value
...
def _fire_approval_hook(hook_name: str, **kwargs) -> None:
    ...
    """
    try:
        from components.cli.api import invoke_hook
    except Exception:
...
def prompt_dangerous_approval(command: str, description: str,
    ...
    try:
        ...
        from components.agent-engine.api import t
        while True:
            print()
...
def _smart_approve(command: str, description: str) -> str:
    ...
    """
    try:
        from components.agent-engine.api import call_llm
