...
import httpx
from components.agent-engine.api import async_call_llm, extract_content_or_reasoning
from components.entry-points.api import get_hermes_dir
...
def _resolve_download_timeout() -> float:
    ...
    if env_val:
        try:
            ...
            pass
    try:
        from components.cli.api import cfg_get, load_config
        cfg = load_config()
...
def _should_use_native_vision_fast_path() -> bool:
    ...
    """
    try:
        from components.agent-engine.api import _read_main_provider, _read_main_model
        from components.agent-engine.api import decide_image_input_mode, _lookup_supports_vision
...
def check_vision_requirements() -> bool:
    ...
    """
    try:
        from components.agent-engine.api import resolve_vision_provider_client
    except ImportError:
        return False
    try:
