...
class HermesACPAgent(acp.Agent):
    ...
    def _build_model_state(self, state: SessionState) -> SessionModelState | None:
        ...
        try:
            from components.cli.api import curated_models_for_provider, normalize_provider, provider_label
    ...
    def _resolve_model_selection(raw_model: str, current_provider: str) -> tuple[str, str]:
        ...
        try:
            from components.cli.api import detect_provider_for_model, parse_model_input
    ...
    def _build_usage_update(state: SessionState) -> UsageUpdate | None:
        ...
        try:
            from components.agent-engine.api import estimate_request_tokens_rough
    ...
    async def _register_session_mcp_servers(
        ...
        try:
            from components.tool-system.api import register_mcp_servers
        ...
        try:
            from components.entry-points.api import get_tool_definitions
            from components.agent-engine.api import inject_memory_provider_tools
    ...
    async def prompt(
        ...
        **kwargs: Any,
        ...
        from components.agent-engine.api import INTERRUPT_WAITING_FOR_MODEL_PREFIX
        ...
        if final_response and not suppress_interrupt_response:
            try:
                from components.agent-engine.api import maybe_auto_title
