...
from components.entry-points.api import atomic_json_write, base_url_host_matches, base_url_hostname

from components.entry-points.api import OPENROUTER_MODELS_URL
...
def get_model_context_length(
    ...
    if effective_provider in {"copilot", "copilot-acp", "github-copilot"}:
        try:
            from components.cli.api import get_copilot_model_context
