...
from components.entry-points.api import is_truthy_value
...
def _collect_gateway_skill_entries(
    ...
    try:
        from components.agent-engine.api import get_skill_commands
...
class SlashCommandCompleter(Completer):
    ...
    def _personality_completions(sub_text: str, sub_lower: str):
        ...
        try:
            ...
            from components.entry-points.api import load_cli_config
