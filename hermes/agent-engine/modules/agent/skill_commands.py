...
def _load_skill_payload(skill_identifier: str, task_id: str | None = None) -> tuple[dict[str, Any], Path | None, str] | None:
    ...
    try:
        from components.tool-system.api import SKILLS_DIR, skill_view
...
def scan_skill_commands() -> Dict[str, Dict[str, Any]]:
    ...
    _skill_commands = {}
    try:
        from components.tool-system.api import SKILLS_DIR, _parse_frontmatter, skill_matches_platform, skill_matches_environment, _get_disabled_skill_names
...
def build_skill_invocation_message(
    ...
    try:
        from components.tool-system.api import bump_use
        bump_use(skill_name)
    except Exception:
