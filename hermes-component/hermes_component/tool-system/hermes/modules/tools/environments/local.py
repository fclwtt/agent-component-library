...
from components.cli.api import windows_hide_flags
...
def _build_provider_env_blocklist() -> frozenset:
    ...
    try:
        from components.cli.api import OPTIONAL_ENV_VARS
...
def _inject_context_hermes_home(env: dict) -> None:
    ...
    try:
        from components.entry-points.api import get_hermes_home_override
...
def _sanitize_subprocess_env(base_env: dict | None, extra_env: dict | None = None) -> dict:
    ...
    from components.entry-points.api import apply_subprocess_home_env
...
def _make_run_env(env: dict) -> dict:
    ...
    try:
        from components.gateway.api import _UNSET, _VAR_MAP
