...
def cmd_status(args: argparse.Namespace) -> int:
    from components.tool-system.api import store_status
...
def cmd_prune(args: argparse.Namespace) -> int:
    from components.tool-system.api import prune_checkpoints
...
def cmd_clear(args: argparse.Namespace) -> int:
    from components.tool-system.api import CHECKPOINT_BASE, clear_all, store_status
...
def cmd_clear_legacy(args: argparse.Namespace) -> int:
    from components.tool-system.api import clear_legacy, store_status
