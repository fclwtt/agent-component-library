...
def check_image_generation_requirements() -> bool:
    ...
    try:
        from components.agent-engine.api import list_providers
...
def _dispatch_to_plugin_provider(
    ...
    try:
        ...
        from components.agent-engine.api import get_provider
        from components.cli.api import _ensure_plugins_discovered
    ...
    try:
        ...
        if reference_image_urls is not None:
            from components.agent-engine.api import normalize_reference_images
