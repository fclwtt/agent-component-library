...
from components.agent-engine.api import extract_user_instruction_from_skill_message
from components.tool-system.api import tool_error
...
class MemoryManager:
    ...
    def add_provider(self, provider: MemoryProvider) -> None:
        ...
        from components.entry-points.api import _HERMES_CORE_TOOLS
