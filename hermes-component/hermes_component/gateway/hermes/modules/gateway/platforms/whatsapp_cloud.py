    ...
    async def _dispatch_interactive_reply(
        ...
        if button_id.startswith("cl:"):
            ...
            if not session_key:
                ...
                return False
            try:
                from components.tool-system.api import resolve_gateway_clarify
            except ImportError:
                logger.warning(
            ...
            if choice == "other":
                ...
                # current task" loop.
                try:
                    from components.tool-system.api import mark_awaiting_text
        ...
        if button_id.startswith("appr:"):
            ...
            if choice not in ("approve", "deny"):
                ...
                return False
            try:
                from components.tool-system.api import resolve_gateway_approval
            except ImportError:
                logger.warning(
