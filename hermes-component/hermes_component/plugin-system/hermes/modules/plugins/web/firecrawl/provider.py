...
from components.tool-system.api import check_website_access
...
class FirecrawlWebSearchProvider(WebSearchProvider):
    ...
    def search(self, query: str, limit: int = 5) -> Dict[str, Any]:
        ...
        ``{"success": False, "error": ...}``.
        """
        from components.tool-system.api import is_interrupted
    ...
    async def extract(self, urls: List[str], **kwargs: Any) -> List[Dict[str, Any]]:
        ...
        """
        from components.tool-system.api import is_interrupted as _is_interrupted
