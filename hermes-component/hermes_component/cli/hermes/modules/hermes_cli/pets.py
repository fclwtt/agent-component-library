...
def _cmd_list(args) -> int:
    ...
    from components.agent-engine.api import ManifestError, fetch_manifest
...
def _cmd_install(args) -> int:
    from agent.pet import store
    from components.agent-engine.api import ManifestError
...
def _cmd_show(args) -> int:
    ...
    from agent.pet import store
    from components.agent-engine.api import DEFAULT_SCALE, LOOP_MS, STATE_ROWS, PetState, resolve_cols
    from components.agent-engine.api import build_renderer
...
def _cmd_doctor(args) -> int:
    ...
    from agent.pet import store
    from components.agent-engine.api import detect_terminal_graphics, resolve_mode
...
def set_pet_scale(value: float | str) -> tuple[float, str | None]:
    ...
    """
    from components.agent-engine.api import clamp_scale
