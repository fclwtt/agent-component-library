...
from components.agent-engine.api import CredentialPool, PooledCredential, get_custom_provider_pool_key, load_pool
...
from components.entry-points.api import OPENROUTER_BASE_URL
from components.entry-points.api import base_url_host_matches, base_url_hostname, env_int
...
def _resolve_explicit_runtime(
    *,
    ...
    if provider == "anthropic":
        ...
        api_key = explicit_api_key
        if not api_key:
            from components.agent-engine.api import resolve_anthropic_token
