...
from components.entry-points.api import display_hermes_home
from components.agent-engine.api import is_excluded_skill_path
...
def _resolve_short_name(name: str, sources, console: Console) -> str:
    ...
    """
    from components.tool-system.api import unified_search
...
def _existing_categories() -> List[str]:
    ...
    """
    from components.tool-system.api import SKILLS_DIR
    out: List[str] = []
    try:
...
def do_search(query: str, source: str = "all", limit: int = 10,
    ...
    """
    from components.tool-system.api import GitHubAuth, create_source_router, unified_search
...
def do_install(identifier: str, category: str = "", force: bool = False,
    ...
    from components.tool-system.api import scan_skill, should_allow_install, format_scan_report
    ...
    try:
        ...
        from components.tool-system.api import append_audit_log
    ...
    try:
        from components.tool-system.api import BlueprintError, blueprint_spec_for_installed, register_blueprint_suggestion
    ...
    if invalidate_cache:
        ...
        try:
            from components.agent-engine.api import clear_skills_system_prompt_cache
...
def do_inspect(identifier: str, console: Optional[Console] = None) -> None:
    ...
    from components.tool-system.api import GitHubAuth, create_source_router
...
def do_list(source_filter: str = "all",
    ...
    """
    from components.tool-system.api import HubLockFile, ensure_hub_dirs
    from components.tool-system.api import _read_manifest
    from components.tool-system.api import _find_all_skills
    from components.agent-engine.api import get_disabled_skill_names
...
def do_check(name: Optional[str] = None, console: Optional[Console] = None) -> None:
    ...
    from components.tool-system.api import check_for_skill_updates
...
def do_update(name: Optional[str] = None, console: Optional[Console] = None) -> None:
    ...
    from components.tool-system.api import HubLockFile, check_for_skill_updates
...
def do_audit(name: Optional[str] = None, console: Optional[Console] = None,
    ...
    are unchanged).
    """
    from components.tool-system.api import HubLockFile, SKILLS_DIR
    from components.tool-system.api import scan_skill, format_scan_report
    ...
    if deep:
        from components.tool-system.api import ast_scan_path, format_ast_report
...
def do_uninstall(name: str, console: Optional[Console] = None,
    ...
    from components.tool-system.api import uninstall_skill
...
def do_reset(name: str, restore: bool = False,
    ...
    from components.tool-system.api import reset_bundled_skill
...
def do_list_modified(console: Optional[Console] = None,
    ...
    from components.tool-system.api import list_user_modified_bundled_skills
...
def do_diff(name: str, console: Optional[Console] = None) -> None:
    ...
    from components.tool-system.api import diff_bundled_skill
...
def do_opt_in(sync: bool = False,
    ...
    """
    from components.tool-system.api import set_bundled_skills_opt_out, sync_skills
...
def do_repair_official(name: str, restore: bool = False,
    ...
    from components.tool-system.api import restore_official_optional_skill
...
def do_tap(action: str, repo: str = "", console: Optional[Console] = None) -> None:
    ...
    from components.tool-system.api import TapsManager
...
def do_publish(skill_path: str, target: str = "github", repo: str = "",
    ...
    from components.tool-system.api import GitHubAuth, SKILLS_DIR
    from components.tool-system.api import scan_skill, format_scan_report
...
def do_snapshot_export(output_path: str, console: Optional[Console] = None) -> None:
    ...
    from components.tool-system.api import HubLockFile, TapsManager
