...
class TeamsSummaryWriter:
    ...
    def _build_graph_client(self, config: dict[str, Any]) -> Any:
        ...
        from components.tool-system.api import MicrosoftGraphTokenProvider
        from components.tool-system.api import MicrosoftGraphClient
...
def check_teams_requirements() -> bool:
    ...
    from components.tool-system.api import ensure_and_bind
...
class TeamsAdapter(BasePlatformAdapter):
    ...
    async def _fetch_attachment_bytes(self, url: str, timeout: float = 30.0) -> bytes:
        ...
        from components.gateway.api import _ssrf_redirect_guard
    ...
    async def _on_card_action(
        ...
        from components.tool-system.api import resolve_gateway_approval, has_blocking_approval
