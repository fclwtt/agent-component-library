...
from components.entry-points.api import safe_json_loads
...
def _diff_ansi() -> dict[str, str]:
    ...
    try:
        from components.cli.api import get_active_skin
...
def _resolve_skill_manage_paths(args: dict) -> list[Path]:
    ...
    from components.tool-system.api import _find_skill, _resolve_skill_dir
