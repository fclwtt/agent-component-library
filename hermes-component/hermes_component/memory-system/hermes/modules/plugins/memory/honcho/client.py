...
from components.cli.api import _get_default_hermes_home
from components.plugin-system.api import SingletonSlot
...
def get_honcho_client(config: HonchoClientConfig | None = None) -> Honcho:
    ...
    def _build() -> "Honcho":
        ...
        try:
            from components.tool-system.api import FeatureUnavailable, ensure as _lazy_ensure
