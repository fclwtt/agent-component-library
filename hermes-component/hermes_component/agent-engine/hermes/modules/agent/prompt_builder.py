...
from components.entry-points.api import get_hermes_home, get_skills_dir, is_wsl
...
from components.entry-points.api import atomic_json_write
...
def _probe_remote_backend(env_type: str) -> str | None:
    ...
    try:
        ...
        from components.tool-system.api import _get_env_config  # type: ignore
...
def build_nous_subscription_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    ...
    try:
        from components.cli.api import get_nous_subscription_features
        from components.tool-system.api import managed_nous_tools_enabled
...
def load_soul_md(context_length: Optional[int] = None) -> Optional[str]:
    ...
    """
    try:
        from components.cli.api import ensure_hermes_home
        ensure_hermes_home()
    except Exception as e:
