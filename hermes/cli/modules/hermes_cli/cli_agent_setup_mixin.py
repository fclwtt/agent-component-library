...
class CLIAgentSetupMixin:
    ...
    def _ensure_runtime_credentials(self) -> bool:
        ...
        """
        from components.entry-points.api import ChatConsole, _cprint, logger
    ...
    def _init_agent(self, *, model_override: str = None, runtime_override: dict = None, request_overrides: dict | None = None) -> bool:
        ...
        """
        from components.entry-points.api import AIAgent, ChatConsole, _DIM, _RST, _accent_hex, _cprint, _prepare_deferred_agent_startup, logger
        ...
        if self._session_db is None:
            try:
                from components.entry-points.api import SessionDB
        ...
        try:
            ...
            try:
                from components.agent-engine.api import seed_credits_at_session_start
    ...
    def _preload_resumed_session(self) -> bool:
        ...
        """
        from components.entry-points.api import _accent_hex
    ...
    def _display_resumed_history(self):
        ...
        """
        from components.entry-points.api import CLI_CONFIG, _record_output_history_entry, _strip_reasoning_tags, _suspend_output_history
