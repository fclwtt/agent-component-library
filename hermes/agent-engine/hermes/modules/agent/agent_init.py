...
from components.cli.api import get_provider_request_timeout
from components.entry-points.api import get_hermes_home
from components.entry-points.api import base_url_host_matches, is_truthy_value
...
def init_agent(
    ...
    from components.entry-points.api import setup_logging, setup_verbose_logging
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        if _is_bedrock_anthropic:
            ...
            if agent.provider == "minimax-oauth" and isinstance(effective_key, str) and effective_key:
                try:
                    from components.cli.api import build_minimax_oauth_token_provider
        ...
        if api_key and base_url:
            ...
            if base_url_host_matches(effective_base, "openrouter.ai"):
                ...
                from components.cli.api import copilot_default_headers
            ...
            if _routed_client is not None:
                ...
                if _explicit and _explicit not in {"auto", "openrouter", "custom"}:
                    ...
                    try:
                        from components.cli.api import PROVIDER_REGISTRY
    ...
    try:
        from components.gateway.api import set_current_session_id
    ...
    from components.tool-system.api import CheckpointManager
    ...
    from components.tool-system.api import TodoStore
    ...
    if not skip_memory:
        try:
            ...
            if agent._memory_enabled or agent._user_profile_enabled:
                from components.memory-system.api import MemoryStore
        ...
        try:
            ...
            if _mem_provider_name and _mem_provider_name.strip():
                ...
                if agent._memory_manager.providers:
                    ...
                    try:
                        from components.cli.api import get_active_profile_name
    ...
    try:
        from components.cli.api import get_compatible_custom_providers
    ...
    if _config_context_length is None and _custom_providers:
        try:
            from components.cli.api import get_custom_provider_context_length
    ...
    if _engine_name != "compressor":
        ...
        if _selected_engine is None:
            _candidate = None
            try:
                from components.cli.api import get_plugin_context_engine
